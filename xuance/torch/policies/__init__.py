...
from .core import OneHotCategoricalActorNet
from .core import GaussianCriticNet
...
from .categorical import DreamerV2DISPolicy as Categorical_DreamerV2_Policy
...
REGISTRY_Policy = {
    ...
    # ↓ Model-Based DRL ↓ #
    "Categorical_DreamerV2": Categorical_DreamerV2_Policy
}

__all__ = [
    "REGISTRY_Policy", "Mixer",
    "ActorNet", "CategoricalActorNet", "CategoricalActorNet_SAC", "GaussianActorNet", "GaussianActorNet_SAC",
    "BasicQhead", "CriticNet", "GaussianActorNet_SAC", "OneHotCategoricalActorNet", "GaussianCriticNet",
